...
# PR-033: read-only role for the Silver DQ Glue job.
output "glue_dq_job_role_arn" {
  description = "ARN of the Silver DQ Glue job role."
  value       = aws_iam_role.glue_dq_job.arn
}
